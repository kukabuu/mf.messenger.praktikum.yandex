...
var Entry = /** @class */ (function (_super) {
    ...
    function Entry(_a) {
        var _b = _a.eventListeners, eventListeners = _b === void 0 ? [] : _b, props = __rest(_a, ["eventListeners"]);
        var _this = _super.call(this, __assign({ eventListeners: eventListeners }, props)) || this;
