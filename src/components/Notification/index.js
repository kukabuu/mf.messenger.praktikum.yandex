...
var Notification = /** @class */ (function (_super) {
    ...
    function Notification(_a) {
        var _b = _a.title, title = _b === void 0 ? 'Успешно!' : _b, _c = _a.status, status = _c === void 0 ? 'notification--success' : _c, props = __rest(_a, ["title", "status"]);
        return _super.call(this, __assign({ title: title, status: status }, props)) || this;
    }
