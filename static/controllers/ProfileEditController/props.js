...
function changeAvatar($form, event) {
...
export const popupProps = {
    ...
    eventListeners: [
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'submit', '#popup-update-avatar .js-form', changeAvatar);
            }
        },
        {
...
export const props = {
    ...
    eventListeners: [
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'submit', '.js-form', submitForm);
            }
        },
        {
