...
function toggleTooltip(element) {
    console.log('FROM TOGGLE TOOLTIP');
...
export const inputDeleteChatProps = {
    id: 'chat-delete',
    value: '1234',
    name: 'chatId',
    isHidden: true,
...
const popupFileProps = {
    ...
    eventListeners: [
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'change', '.js-file-upload', displayFileName);
            }
        },
    ]
};
const popupAddUserProps = {
    ...
    eventListeners: [
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'submit', '#popup-add-user .js-form', listenerAddUser);
            }
        }
    ]
};
const popupRemoveUserProps = {
    ...
    eventListeners: [
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'submit', '#popup-remove-user .js-form', listenToDeleteUser);
            }
        }
    ]
};
    ...
    eventListeners: [
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'submit', '#popup-chat-delete .js-form', listenToDeleteChatProps);
            }
        }
    ]
};
            ...
            options: [
                {
                    ...
                    href: '#popup-add-user',
                    className: 'option--add-user js-user-add'
                },
                {
                    text: 'Удалить пользователя',
                    href: '#popup-remove-user',
                    className: 'option--remove-user js-user-delete'
                },
                {
                    text: 'Удалить чат',
                    href: '#popup-chat-delete',
                    className: 'option--delete-chat js-chat-delete'
                },
            ],
        }
    },
            ...
            options: [
                {
                    ...
                    className: 'option--add-foto js-add-file'
                },
                {
                    text: 'Файл',
                    href: '#popup-upload-file',
                    className: 'option--add-file js-add-file'
                },
            ]
        },
        sendMessage: {
    ...
    eventListeners: [
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'click', '.js-create-new-chat', ($element, event) => {
                    event.preventDefault();
        ...
        },
        {
            ...
            callback: () => {
                addEventForChild(document.body, 'click', '.js-tooltip__button', toggleTooltip);
            }
        },
        {
            ...
            callback: () => {
                ...
                addEventForChild(document.body, 'click', '.js-chat-create', togglePopup);
            }
        },
        {
            event: 'event-listener:toggle-popup',
            callback: () => {
                console.log('event-listener:toggle-popup');
                addEventForChild(document.body, 'click', '.js-chat-delete', togglePopup);
            }
        },
        {
            event: 'event-listener:toggle-popup',
            callback: () => {
                console.log('event-listener:toggle-popup');
                addEventForChild(document.body, 'click', '.js-user-add', togglePopup);
            }
        },
        {
            event: 'event-listener:toggle-popup',
            callback: () => {
                console.log('event-listener:toggle-popup');
                addEventForChild(document.body, 'click', '.js-user-delete', togglePopup);
            }
        },
        {
            event: 'event-listener:toggle-popup',
            callback: () => {
                console.log('event-listener:toggle-popup');
                addEventForChild(document.body, 'click', '.js-add-file', togglePopup);
            }
        },
        {
            event: 'event-listener:toggle-popup',
            callback: () => {
                console.log('event-listener:toggle-popup');
                addEventForChild(document.body, 'click', '.js-popup-close', closePopup);
            }
        },
    ],
